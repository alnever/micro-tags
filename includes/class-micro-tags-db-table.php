...
/**
 * Base class for micro-tags db table
 *
 ...
 */
 ...
 if (! class_exists('Micro_Tags_Db'))
  require_once(dirname(__FILE__) . "/class-micro-tags-db.php");

  class Micro_Tags_Db_Table{
    ...
    {
      $this->connection = Micro_Tags_Db::get_instance();
